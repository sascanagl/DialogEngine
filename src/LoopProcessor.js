...
const nS = "$n{"; // targetted npc stat (property:value)
...
class LoopProcessor {
    ...
    doInput(ins, gameState){
        ...
        message           = this.getMessaging(message, gameState, rS); 
        message           = this.getMessaging(message, gameState, mS); 
        message           = this.getMessaging(message, gameState, sS); 
        gameState.instext = gameState.instext.concat("\n", this.getMessaging(message, gameState, lstS), "\n"); 
        return gameState;
    }
